...
| Projekt | Frontend (UI) | Backend (Swagger/API) |
| :--- | :--- | :--- |
| **Lab 01: Library** | [http://localhost:8080](http://localhost:8080) | [http://localhost:8000/docs](http://localhost:8000/docs) |
| **Lab 02: Shop** | [http://localhost:8081](http://localhost:8081) | [http://localhost:8001/docs](http://localhost:8001/docs) |
| **Lab 03: Blog** | [http://localhost:8082](http://localhost:8082) | [http://localhost:8002/docs](http://localhost:8002/docs) |
| **Lab 04: Movies** | [http://localhost:8083](http://localhost:8083) | [http://localhost:8003/docs](http://localhost:8003/docs) |
| **Lab 05: Kanban** | [http://localhost:8084](http://localhost:8084) | [http://localhost:8004/docs](http://localhost:8004/docs) |
